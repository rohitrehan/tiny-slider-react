...
export interface TinySliderConfig extends TinySliderSettings {
  onClick?: (
...
export const TinySlider = forwardRef(
  (props: TinySliderConfig, ref: (ref: TinySliderInstance) => void) => {
    ...
    const build = useCallback(
      (newSettings: TinySliderConfig = {}) => {
        const settings: TinySliderConfig = {
          ...newSettings,
          onInit: () => {
            setTimeout(postInit)
          },
